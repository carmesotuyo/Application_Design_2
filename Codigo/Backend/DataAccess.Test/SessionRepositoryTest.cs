...
namespace DataAccess.Test
{
    ...
    public class SessionRepositoryTest
    {
        ...
        public void AddSession_UserAlreadyHasActiveSession_ThrowsAlreadyExistsDbException()
        {
            ...
            Session session1 = new Session { User = user, Token = Guid.Parse("token1"), DateTimeLogin = DateTime.Now };
            _dbContext.Sessions.Add(session1);
            _dbContext.SaveChanges();

            Session session2 = new Session { User = user, Token = Guid.Parse("token2"), DateTimeLogin = DateTime.Now };
        ...
        public void AddSession_UserDoesNotHaveActiveSession_ReturnsSession()
        {
            ...
            var session = new Session { Id = 1, User = user, Token = Guid.Parse("token"), DateTimeLogin = DateTime.Now };
        ...
        public void Get_SessionExists_ReturnsSession()
        {
            ...
            var session = new Session { Id = 1, Token = Guid.Parse("abc123"), User = user, DateTimeLogin = DateTime.Now };
        ...
        public void GetSessions_Successful()
        {
            ...
            var session1 = new Session { Id = 1, User = user1, Token = Guid.Parse("1212"), DateTimeLogin = DateTime.Now.AddMinutes(-30) };
            var session2 = new Session { Id = 2, User = user2, Token = Guid.Parse("1312"), DateTimeLogin = DateTime.Now.AddDays(-1), DateTimeLogout = DateTime.Now };
            var session3 = new Session { Id = 3, User = user1, Token = Guid.Parse("1412"), DateTimeLogin = DateTime.Now.AddHours(-2), DateTimeLogout = DateTime.Now.AddHours(-1) };
        ...
        public void Exists_SessionExists_ReturnsTrue()
        {
            // Arrange
            var user1 = new User("testuser2", "pass", "ba@aa.com", "nano", "nanito", true, false);
            var session = new Session { Id = 1, User = user1, Token = Guid.Parse("1212"), DateTimeLogin = DateTime.Now.AddMinutes(-30) };
            _dbContext.Set<Session>().Add(session);
            _dbContext.SaveChanges();
